...
## Offline evaluation
Deterministic retrieval and optional RAGAS evaluation are available only through the CLI; they are never called by normal chat requests. See [`backend/evaluation/README.md`](backend/evaluation/README.md) for dataset labelling and commands.
